                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          // const TextSpan(text: '\n'),
                          const TextSpan(text: '\n\n\n'),
                          const TextSpan(text: 'تم تطوير هذا التطبيق بواسطة '),
                          const TextSpan(text: 'Ah M eD ', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.lightBlue)),
                          const TextSpan(text: ' باستخدام Flutter'),
                        ],
                      ),
                    ),
                  ),
